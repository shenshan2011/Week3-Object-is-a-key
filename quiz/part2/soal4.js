...
function checkAB(num) {
    ...
    for (let i = 0; i < num.length -4 ; i++) {
        ...
        // kok kayak gampang banget sir? jangan sampai soal latihan,
        //  nya gampang tapi ujian nya susah nya bukan main
        // kayak sekolahan saya, latihan nya gamapang ujian nya susah
    }
    return false;
  }
